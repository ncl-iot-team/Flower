<%-- 
    Document   : homeBody
    Created on : 14/02/2016, 7:11:44 PM
    Author     : kho01f
--%>
    ...
    <section>
        <!--div class="row">
          <div class="col-lg-12 page-header text-center">
            <h2>Flower Services</h2>
          </div>
        </div-->
        <div class="container ">
            <div class="row">
                <div class="col-lg-4 col-sm-12 text-center"> <img class="img-circle" alt="140x140" style="width: 140px; height: 140px;" src="${pageContext.request.contextPath}/resources/img/Down.png" data-holder-rendered="true">
                    <h3>All-in-One-Place Visualization</h3>
                    <p>Cross Platform Monitoring</p>
...
<!--                <div class="col-sm-12 text-center col-lg-6"><img class="img-circle" alt="140x140" style="width: 140px; height: 140px;" src="${pageContext.request.contextPath}/resources/img/Cloud.png" data-holder-rendered="true">
                ...
                <div class="col-sm-12 text-center col-lg-6"><img class="img-circle" alt="140x140" style="width: 140px; height: 140px;" src="${pageContext.request.contextPath}/resources/img/Money.png"data-holder-rendered="true">
                    <h3>Cloud Services Cost Management</h3>
                    <p>Resource Cost Analysis per Analytics Flow</p>
